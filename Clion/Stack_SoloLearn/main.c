...
//## is an pre processor token parsing operator which parse tokens and merge them ##__## is define any macro beside or after that operator
// / this is use to indent the code in C
...
// pushing in array is performed by this
    printf("pushing:");
    for (i='a';i<='z';i++) {
        printf(" %c", i);
        stk_int_push(stk, i);
